...
const faqData: FaqItem[] = [
  {
    question: 'What is the Gravity Field?',
    answer:
      'The Gravity Field is a machine-readable operating context \u2014 the encoded knowledge of your brand, your buyers, your competitive position, your content architecture, and your measurement framework \u2014 built so that every AI tool, every agent, and every team member works from the same shared foundation. It is not a document, a prompt template, or a one-time brand exercise. It is a living operating system that updates as the market moves.',
  },
  {
    question: 'How is this different from hiring a fractional CMO?',
    answer:
      'A fractional CMO provides leadership and strategy. When they leave, the strategy leaves with them. The Gravity Field is infrastructure \u2014 it persists after the engagement ends. Your team and your agents operate from it indefinitely. Building it requires simultaneous fluency in GTM strategy, technical infrastructure, creative production systems, and AI-native thinking \u2014 four disciplines that almost never coexist in a single hire.',
  },
  {
    question: 'How long does it take to build the Gravity Field?',
    answer:
  ...
  {
    question: 'What does the Gravity Field cost?',
    answer:
      'The diagnostic ranges from $2,500\u2013$25,000 depending on scope (external audit vs. deep internal audit). The full build sprint ranges from $25,000\u2013$75,000. The ongoing advisor retainer is $5,000\u2013$15,000 per month. A full transformation engagement runs $75,000\u2013$150,000+. For comparison: a single CMO hire costs $350K+ fully loaded per year. The Gravity Field sprint costs less than one quarter of that salary and produces infrastructure that persists.',
  },
  {
    question: 'Can we build this internally?',
    answer:
      'Your team can run the system once it is built. Building the Gravity Field requires understanding how AI models ingest context, how agents learn from data structures, and how to encode brand and competitive intelligence in formats agents can actually use. That is not marketing ops \u2014 it is a different discipline. Strategnik builds it, trains your team, and hands it off. They operate it.',
  },
  {
    question: 'We already have a CMO and marketing team. Is this a replacement?',
    answer:
      'No. The Gravity Field is not here to replace your CMO or your team. It gives them a new set of operating instructions for a world where agents are part of the team. The CMO stays. The team stays. What changes is the infrastructure they operate from. The CMO steers the layer. The layer steers everything else.',
  },
  {
