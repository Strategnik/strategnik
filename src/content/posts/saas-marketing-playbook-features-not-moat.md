---
title: 'The SaaS Marketing Playbook When Features Stop Being Your Moat'
description: >-
...
This is the second in a three-part series on how SaaS go-to-market teams need to adapt when features stop being the moat. This post covers marketing. The companion pieces cover [sales](/thinking/saas-sales-playbook-features-not-moat) and [customer success](/thinking/saas-cs-playbook-features-not-moat).
...
Marketing's infrastructure problem is different from what sales faces. The [sales post in this series](/thinking/saas-sales-playbook-features-not-moat) covers how sales needs depth on individual accounts. Marketing needs breadth across the entire market — and the ability to maintain quality at volume.
...
*This is part two of a three-part series. Read the companion pieces on [how sales builds friction when features commoditize](/thinking/saas-sales-playbook-features-not-moat) and [how customer success shifts from retention to mass accumulation](/thinking/saas-cs-playbook-features-not-moat).*
